...
bool actions_quiz_msg__msg__age__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("actions_quiz_msg.msg._age.Age", full_classname_dest, 29) == 0);
  }
  actions_quiz_msg__msg__Age * ros_message = _ros_message;
  {  // year
  ...
  {  // month
    ...
    assert(PyLong_Check(field));
    ros_message->month = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // day
...
PyObject * actions_quiz_msg__msg__age__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("actions_quiz_msg.msg._age");
