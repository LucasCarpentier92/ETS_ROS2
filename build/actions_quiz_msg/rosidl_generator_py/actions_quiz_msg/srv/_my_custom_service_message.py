...
class Metaclass_MyCustomServiceMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_quiz_msg.srv.MyCustomServiceMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from actions_quiz_msg.srv import _my_custom_service_message
...
class MyCustomServiceMessage(metaclass=Metaclass_MyCustomServiceMessage):
    from actions_quiz_msg.srv._my_custom_service_message import MyCustomServiceMessage_Request as Request
    from actions_quiz_msg.srv._my_custom_service_message import MyCustomServiceMessage_Response as Response
