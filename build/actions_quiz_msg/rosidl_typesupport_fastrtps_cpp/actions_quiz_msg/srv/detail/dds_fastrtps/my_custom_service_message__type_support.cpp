...
#include "actions_quiz_msg/srv/detail/my_custom_service_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const actions_quiz_msg::srv::MyCustomServiceMessage_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  actions_quiz_msg::srv::MyCustomServiceMessage_Request & ros_message)
{
  // Member: move
  cdr >> ros_message.move;
...
{
  auto typed_message =
    static_cast<const actions_quiz_msg::srv::MyCustomServiceMessage_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<actions_quiz_msg::srv::MyCustomServiceMessage_Request *>(
    untyped_ros_message);
...
static size_t _MyCustomServiceMessage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MyCustomServiceMessage_Request(full_bounded, is_plain, 0);
...
{
  return &actions_quiz_msg::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, actions_quiz_msg, srv, MyCustomServiceMessage_Request)() {
  return &actions_quiz_msg::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_actions_quiz_msg
cdr_serialize(
  const actions_quiz_msg::srv::MyCustomServiceMessage_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  actions_quiz_msg::srv::MyCustomServiceMessage_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const actions_quiz_msg::srv::MyCustomServiceMessage_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<actions_quiz_msg::srv::MyCustomServiceMessage_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _MyCustomServiceMessage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MyCustomServiceMessage_Response(full_bounded, is_plain, 0);
...
{
  return &actions_quiz_msg::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, actions_quiz_msg, srv, MyCustomServiceMessage_Response)() {
  return &actions_quiz_msg::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Response__handle;
}
...
{
  return &actions_quiz_msg::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, actions_quiz_msg, srv, MyCustomServiceMessage)() {
  return &actions_quiz_msg::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage__handle;
}
