...
class Metaclass_Move_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('actions_quiz_msg')
        except ImportError:
            import logging
            import traceback
    ...
    def secs(self, value):
        if __debug__:
            assert \
                ...
                "The 'secs' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'secs' field must be an integer in [-2147483648, 2147483647]"
        self._secs = value
...
class Metaclass_Move_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from actions_quiz_msg.action import Move
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'actions_quiz_msg/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['actions_quiz_msg', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from actions_quiz_msg.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_quiz_msg.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from actions_quiz_msg.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from actions_quiz_msg.action._move import Move_SendGoal_Request as Request
    from actions_quiz_msg.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'actions_quiz_msg/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['actions_quiz_msg', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from actions_quiz_msg.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_quiz_msg.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from actions_quiz_msg.action._move import Move_GetResult_Request as Request
    from actions_quiz_msg.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'actions_quiz_msg.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'actions_quiz_msg/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['actions_quiz_msg', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from actions_quiz_msg.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from actions_quiz_msg.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from actions_quiz_msg.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from actions_quiz_msg.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from actions_quiz_msg.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from actions_quiz_msg.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from actions_quiz_msg.action._move import Move_FeedbackMessage as FeedbackMessage
