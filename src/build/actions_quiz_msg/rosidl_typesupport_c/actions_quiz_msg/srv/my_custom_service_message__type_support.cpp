...
static const _MyCustomServiceMessage_Request_type_support_symbol_names_t _MyCustomServiceMessage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, actions_quiz_msg, srv, MyCustomServiceMessage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, actions_quiz_msg, srv, MyCustomServiceMessage_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, actions_quiz_msg, srv, MyCustomServiceMessage_Request)() {
  return &::actions_quiz_msg::srv::rosidl_typesupport_c::MyCustomServiceMessage_Request_message_type_support_handle;
}
...
static const _MyCustomServiceMessage_Response_type_support_symbol_names_t _MyCustomServiceMessage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, actions_quiz_msg, srv, MyCustomServiceMessage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, actions_quiz_msg, srv, MyCustomServiceMessage_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, actions_quiz_msg, srv, MyCustomServiceMessage_Response)() {
  return &::actions_quiz_msg::srv::rosidl_typesupport_c::MyCustomServiceMessage_Response_message_type_support_handle;
}
...
static const _MyCustomServiceMessage_type_support_symbol_names_t _MyCustomServiceMessage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, actions_quiz_msg, srv, MyCustomServiceMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, actions_quiz_msg, srv, MyCustomServiceMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, actions_quiz_msg, srv, MyCustomServiceMessage)() {
  return &::actions_quiz_msg::srv::rosidl_typesupport_c::MyCustomServiceMessage_service_type_support_handle;
}
