...
actions_quiz_msg__msg__Age__create()
{
  ...
  actions_quiz_msg__msg__Age * msg = (actions_quiz_msg__msg__Age *)allocator.allocate(sizeof(actions_quiz_msg__msg__Age), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(actions_quiz_msg__msg__Age));
  bool success = actions_quiz_msg__msg__Age__init(msg);
  if (!success) {
...
actions_quiz_msg__msg__Age__destroy(actions_quiz_msg__msg__Age * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    actions_quiz_msg__msg__Age__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
actions_quiz_msg__msg__Age__Sequence__init(actions_quiz_msg__msg__Age__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  actions_quiz_msg__msg__Age * data = NULL;

  if (size) {
    data = (actions_quiz_msg__msg__Age *)allocator.zero_allocate(size, sizeof(actions_quiz_msg__msg__Age), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = actions_quiz_msg__msg__Age__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        actions_quiz_msg__msg__Age__fini(&data[i - 1]);
      }
...
actions_quiz_msg__msg__Age__Sequence__fini(actions_quiz_msg__msg__Age__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      actions_quiz_msg__msg__Age__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  actions_quiz_msg__msg__Age__Sequence * array = (actions_quiz_msg__msg__Age__Sequence *)allocator.allocate(sizeof(actions_quiz_msg__msg__Age__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = actions_quiz_msg__msg__Age__Sequence__init(array, size);
  if (!success) {
...
actions_quiz_msg__msg__Age__Sequence__destroy(actions_quiz_msg__msg__Age__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    actions_quiz_msg__msg__Age__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
actions_quiz_msg__msg__Age__Sequence__are_equal(const actions_quiz_msg__msg__Age__Sequence * lhs, const actions_quiz_msg__msg__Age__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!actions_quiz_msg__msg__Age__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  actions_quiz_msg__msg__Age__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(actions_quiz_msg__msg__Age);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    actions_quiz_msg__msg__Age * data =
      (actions_quiz_msg__msg__Age *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!actions_quiz_msg__msg__Age__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          actions_quiz_msg__msg__Age__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!actions_quiz_msg__msg__Age__copy(
